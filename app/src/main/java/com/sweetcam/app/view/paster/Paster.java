...
public abstract class Paster {
    ...
    @NonNull
    public Paster setFlippedHorizontally(boolean flippedHorizontally) {
    ...
    @NonNull
    public Paster setFlippedVertically(boolean flippedVertically) {
    ...
    public Paster setMatrix(@Nullable Matrix matrix) {
    ...
    public abstract Paster setDrawable(@NonNull Drawable drawable);

    @NonNull
    public abstract Drawable getDrawable();

    @NonNull
    public abstract Paster setAlpha(@IntRange(from = 0, to = 255) int alpha);
    ...
    public boolean contains(@NonNull float[] point) {
        ...
        PasterUtils.trapToRect(trappedRect, unrotatedWrapperCorner);
